...
from custom_components.denonavr.const import ATTR_DYNAMIC_EQ
from custom_components.denonavr.services import (
    ATTR_COMMAND,
    SERVICE_GET_COMMAND,
...
def client_fixture():
    ...
    with (
        patch(
            "custom_components.denonavr.receiver.DenonAVR",
            autospec=True,
