...
def denonavr_connect_fixture():
    ...
    with (
        patch(
            "custom_components.denonavr.receiver.DenonAVR.async_setup",
            return_value=None,
        ),
        patch(
            "custom_components.denonavr.receiver.DenonAVR.async_update",
            return_value=None,
        ),
        patch(
            "custom_components.denonavr.receiver.DenonAVR.support_sound_mode",
            return_value=True,
        ),
        patch(
            "custom_components.denonavr.receiver.DenonAVR.name",
            TEST_NAME,
        ),
        patch(
            "custom_components.denonavr.receiver.DenonAVR.model_name",
            TEST_MODEL,
        ),
        patch(
            "custom_components.denonavr.receiver.DenonAVR.serial_number",
            TEST_SERIALNUMBER,
        ),
        patch(
            "custom_components.denonavr.receiver.DenonAVR.manufacturer",
            TEST_MANUFACTURER,
        ),
        patch(
            "custom_components.denonavr.receiver.DenonAVR.receiver_type",
            TEST_RECEIVER_TYPE,
        ),
        patch(
            "custom_components.denonavr.async_setup_entry",
            return_value=True,
        ),
    ):
        yield
...
async def test_config_flow_manual_discover_1_success(hass: HomeAssistant) -> None:
    ...
    with patch(
        "custom_components.denonavr.config_flow.denonavr.async_discover",
